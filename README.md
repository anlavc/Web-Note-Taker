...
*   **Sağ Tık Menüsü**: Web sayfasındaki herhangi bir metni seçip sağ tıklayarak "Web Notuna Ekle" seçeneği ile hızlıca not alabilirsiniz.
*   **Not Yönetimi (Ayarlar Sayfası)**:
    *   Tüm kayıtlı notlarınızı liste halinde görebilirsiniz.
    *   Notlarınız arasında (Başlık, İçerik veya URL'e göre) **Arama** yapabilirsiniz.
